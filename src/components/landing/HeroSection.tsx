      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm text-white/90 mb-6 border border-white/10"
          >
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-[2.75rem] xl:text-5xl font-bold text-white leading-[1.2] tracking-tight">
            ...
            <span className="relative inline-block mt-1">
              تقييمات
              <span className="text-star"> Google </span>
              أكثر
              <motion.div
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
                transition={{ delay: 0.8, duration: 0.5 }}
                className="absolute -bottom-1 left-0 right-0 h-1 bg-star/40 rounded-full origin-right"
              />
            </span>
          </h1>

          <p className="mt-5 text-base lg:text-lg text-white/70 max-w-lg mx-auto lg:mx-0 lg:mr-0 leading-relaxed">
                ...
                <div className="bg-gradient-to-b from-primary/90 to-primary rounded-[2rem] overflow-hidden pt-8 pb-6 px-5 min-h-[420px] flex flex-col">
                  <div className="text-center mb-6">
                    <div className="w-12 h-12 rounded-full bg-white/15 mx-auto flex items-center justify-center mb-3">
                      <Star className="h-6 w-6 text-star fill-star" />
                    </div>
